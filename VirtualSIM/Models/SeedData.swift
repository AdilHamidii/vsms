...
enum SeedData {
    ...
    static let countries: [Country] = [
        ...
        .init(id: "it", name: "Italy",          flag: "🇮🇹", dialCode: "+39",  smspvaCode: "IT", stock: .medium, avgSeconds: 35, sortOrder: 80),
        .init(id: "es", name: "Spain",          flag: "🇪🇸", dialCode: "+34",  smspvaCode: "ES", stock: .medium, avgSeconds: 35, sortOrder: 90),
        .init(id: "pl", name: "Poland",         flag: "🇵🇱", dialCode: "+48",  smspvaCode: "PL", stock: .high,   avgSeconds: 30, sortOrder: 100),
        .init(id: "se", name: "Sweden",         flag: "🇸🇪", dialCode: "+46",  smspvaCode: "SE", stock: .medium, avgSeconds: 32, sortOrder: 110),
        .init(id: "no", name: "Norway",         flag: "🇳🇴", dialCode: "+47",  smspvaCode: "NO", stock: .medium, avgSeconds: 34, sortOrder: 120),
        .init(id: "fi", name: "Finland",        flag: "🇫🇮", dialCode: "+358", smspvaCode: "FI", stock: .medium, avgSeconds: 36, sortOrder: 130),
        .init(id: "dk", name: "Denmark",        flag: "🇩🇰", dialCode: "+45",  smspvaCode: "DK", stock: .medium, avgSeconds: 32, sortOrder: 140),
        .init(id: "be", name: "Belgium",        flag: "🇧🇪", dialCode: "+32",  smspvaCode: "BE", stock: .medium, avgSeconds: 34, sortOrder: 150),
        .init(id: "at", name: "Austria",        flag: "🇦🇹", dialCode: "+43",  smspvaCode: "AT", stock: .medium, avgSeconds: 33, sortOrder: 160),
        .init(id: "ch", name: "Switzerland",    flag: "🇨🇭", dialCode: "+41",  smspvaCode: "CH", stock: .medium, avgSeconds: 35, sortOrder: 170),
        .init(id: "cz", name: "Czechia",        flag: "🇨🇿", dialCode: "+420", smspvaCode: "CZ", stock: .medium, avgSeconds: 36, sortOrder: 180),
        .init(id: "pt", name: "Portugal",       flag: "🇵🇹", dialCode: "+351", smspvaCode: "PT", stock: .medium, avgSeconds: 38, sortOrder: 190),
        .init(id: "ro", name: "Romania",        flag: "🇷🇴", dialCode: "+40",  smspvaCode: "RO", stock: .medium, avgSeconds: 40, sortOrder: 200),
        .init(id: "ie", name: "Ireland",        flag: "🇮🇪", dialCode: "+353", smspvaCode: "IE", stock: .medium, avgSeconds: 33, sortOrder: 210),
        .init(id: "ru", name: "Russia",         flag: "🇷🇺", dialCode: "+7",   smspvaCode: "RU", stock: .high,   avgSeconds: 35, sortOrder: 220),
        .init(id: "ua", name: "Ukraine",        flag: "🇺🇦", dialCode: "+380", smspvaCode: "UA", stock: .high,   avgSeconds: 38, sortOrder: 230),
        .init(id: "kz", name: "Kazakhstan",     flag: "🇰🇿", dialCode: "+7",   smspvaCode: "KZ", stock: .high,   avgSeconds: 40, sortOrder: 240),
        .init(id: "by", name: "Belarus",        flag: "🇧🇾", dialCode: "+375", smspvaCode: "BY", stock: .medium, avgSeconds: 42, sortOrder: 250),
        .init(id: "mx", name: "Mexico",         flag: "🇲🇽", dialCode: "+52",  smspvaCode: "MX", stock: .high,   avgSeconds: 38, sortOrder: 260),
        .init(id: "br", name: "Brazil",         flag: "🇧🇷", dialCode: "+55",  smspvaCode: "BR", stock: .high,   avgSeconds: 42, sortOrder: 270),
        .init(id: "ar", name: "Argentina",      flag: "🇦🇷", dialCode: "+54",  smspvaCode: "AR", stock: .medium, avgSeconds: 44, sortOrder: 280),
        .init(id: "co", name: "Colombia",       flag: "🇨🇴", dialCode: "+57",  smspvaCode: "CO", stock: .medium, avgSeconds: 45, sortOrder: 290),
        .init(id: "cl", name: "Chile",          flag: "🇨🇱", dialCode: "+56",  smspvaCode: "CL", stock: .medium, avgSeconds: 46, sortOrder: 300),
        .init(id: "tr", name: "Turkey",         flag: "🇹🇷", dialCode: "+90",  smspvaCode: "TR", stock: .high,   avgSeconds: 40, sortOrder: 310),
        .init(id: "ae", name: "UAE",            flag: "🇦🇪", dialCode: "+971", smspvaCode: "AE", stock: .medium, avgSeconds: 38, sortOrder: 320),
        .init(id: "sa", name: "Saudi Arabia",   flag: "🇸🇦", dialCode: "+966", smspvaCode: "SA", stock: .medium, avgSeconds: 42, sortOrder: 330),
        .init(id: "eg", name: "Egypt",          flag: "🇪🇬", dialCode: "+20",  smspvaCode: "EG", stock: .medium, avgSeconds: 45, sortOrder: 340),
        .init(id: "il", name: "Israel",         flag: "🇮🇱", dialCode: "+972", smspvaCode: "IL", stock: .medium, avgSeconds: 36, sortOrder: 350),
        .init(id: "za", name: "South Africa",   flag: "🇿🇦", dialCode: "+27",  smspvaCode: "ZA", stock: .medium, avgSeconds: 48, sortOrder: 360),
        .init(id: "ng", name: "Nigeria",        flag: "🇳🇬", dialCode: "+234", smspvaCode: "NG", stock: .medium, avgSeconds: 50, sortOrder: 370),
        .init(id: "ke", name: "Kenya",          flag: "🇰🇪", dialCode: "+254", smspvaCode: "KE", stock: .medium, avgSeconds: 52, sortOrder: 380),
        .init(id: "ma", name: "Morocco",        flag: "🇲🇦", dialCode: "+212", smspvaCode: "MA", stock: .medium, avgSeconds: 48, sortOrder: 390),
        .init(id: "in", name: "India",          flag: "🇮🇳", dialCode: "+91",  smspvaCode: "IN", stock: .high,   avgSeconds: 38, sortOrder: 400),
        .init(id: "id", name: "Indonesia",      flag: "🇮🇩", dialCode: "+62",  smspvaCode: "ID", stock: .high,   avgSeconds: 42, sortOrder: 410),
        .init(id: "ph", name: "Philippines",    flag: "🇵🇭", dialCode: "+63",  smspvaCode: "PH", stock: .high,   avgSeconds: 45, sortOrder: 420),
        .init(id: "vn", name: "Vietnam",        flag: "🇻🇳", dialCode: "+84",  smspvaCode: "VN", stock: .medium, avgSeconds: 46, sortOrder: 430),
        .init(id: "th", name: "Thailand",       flag: "🇹🇭", dialCode: "+66",  smspvaCode: "TH", stock: .medium, avgSeconds: 44, sortOrder: 440),
        .init(id: "my", name: "Malaysia",       flag: "🇲🇾", dialCode: "+60",  smspvaCode: "MY", stock: .medium, avgSeconds: 42, sortOrder: 450),
        .init(id: "sg", name: "Singapore",      flag: "🇸🇬", dialCode: "+65",  smspvaCode: "SG", stock: .medium, avgSeconds: 36, sortOrder: 460),
        .init(id: "jp", name: "Japan",          flag: "🇯🇵", dialCode: "+81",  smspvaCode: "JP", stock: .low,    avgSeconds: 50, sortOrder: 470),
        .init(id: "kr", name: "South Korea",    flag: "🇰🇷", dialCode: "+82",  smspvaCode: "KR", stock: .medium, avgSeconds: 42, sortOrder: 480),
        .init(id: "hk", name: "Hong Kong",      flag: "🇭🇰", dialCode: "+852", smspvaCode: "HK", stock: .medium, avgSeconds: 40, sortOrder: 490),
        .init(id: "tw", name: "Taiwan",         flag: "🇹🇼", dialCode: "+886", smspvaCode: "TW", stock: .medium, avgSeconds: 42, sortOrder: 500),
    ]
}
